const mainDiv = document.getElementById('marvel');
const marvel = [
  {
    "Title": "Irom Man",
    "Year": "2008",
  ...
  },
  {
    ...
    "Response": "True",
     "Images": [
      "https://m.media-amazon.com/images/M/MV5BYzMyNzUxNjMtNjBmMi00YWRmLTk0N2QtODFjZWJmZDc5OGQwXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_.jpg",
  ...
  },
  {
    ...
    "Response": "True",
    "Images": [
      "https://m.media-amazon.com/images/M/MV5BYzMyN2I0NjMtYmZhZS00MWJkLWE1MTktNGM2ZDhmNDE1ZDc0XkEyXkFqcGdeQXVyNDg2NzE0MjE@._V1_.jpg",
  ...
  },
  {
    ...
    "Response": "True",
     "Images": [
      "https://m.media-amazon.com/images/M/MV5BOGM2OWFmNGUtYzgwZi00Mzk3LWE2ZTMtMGQ0NGI2NjAwNjg5XkEyXkFqcGdeQXVyMTExNjIyMTc@._V1_.jpg",
  ...
  },
  {
    ...
    "Language": "English",
    "Country": "USA",
    "Awards": "121 wins & 287 Nominations",
    ...
    "Response": "True",
    "Images": [
      "https://m.media-amazon.com/images/M/MV5BMTg1MTY2MjYzNV5BMl5BanBnXkFtZTgwMTc4NTMwNDI@._V1_SY1000_CR0,0,1497,1000_AL_.jpg",
  ...
  marvel.forEach  (function (marvel)
  {
    console.log(marvel)
    const marvelDiv = document.createElement('div');
    const title = document.createElement('h2')
    title.textContent="Title: "+ marvel.Title
    const year = document.createElement('year')
    year.textContent="Year: "+ marvel.Year
    const imdb = document.createElement('imdb')
    imdb.textContent="IMDB: "+ marvel.imdbRating
    const image = document.createElement('img')
    image.src=marvel.Images
    image.height='200'
    image.width='350'
    const genre = document.createElement('genre')
    genre.textContent= "Genre: " + marvel.Genre
    const awards = document.createElement('awards')
    awards.textContent="Awards: "+ marvel.Awards
    const lang = document.createElement('lang')
    lang.textContent="Language: "+ marvel.Language
    marvelDiv.append(image,title,genre,lang,imdb,year,awards,)
    marvelDiv.classList.add('studio')
    mainDiv.appendChild(marvelDiv);
  })